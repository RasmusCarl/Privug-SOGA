# Generated from PrivugASGMT.g4 by ANTLR 4.10.1
# encoding: utf-8
from antlr4 import *
...
class PrivugASGMTParser ( Parser ):

    grammarFileName = "PrivugASGMT.g4"
    ...
    class AssignmentContext(ParserRuleContext):
        ...
        def symvars(self):
            return self.getTypedRuleContext(PrivugASGMTParser.SymvarsContext,0)


        def add(self):
            return self.getTypedRuleContext(PrivugASGMTParser.AddContext,0)


        def getRuleIndex(self):
            return PrivugASGMTParser.RULE_assignment
    ...
    def assignment(self):
        ...
        localctx = PrivugASGMTParser.AssignmentContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self.symvars()
            self.state = 19
            self.match(PrivugASGMTParser.T__0)
            self.state = 20
            self.add()
    ...
    class AddContext(ParserRuleContext):
        ...
        def add_term(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(PrivugASGMTParser.Add_termContext)
            else:
                return self.getTypedRuleContext(PrivugASGMTParser.Add_termContext,i)


        def getRuleIndex(self):
            return PrivugASGMTParser.RULE_add
    ...
    def add(self):
        ...
        localctx = PrivugASGMTParser.AddContext(self, self._ctx, self.state)
        ...
        try:
            ...
            while _alt!=1 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1+1:
                    ...
                    if _la==PrivugASGMTParser.T__1:
                        self.state = 23
                        self.match(PrivugASGMTParser.T__1)
    ...
    class Add_termContext(ParserRuleContext):
        ...
        def term(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(PrivugASGMTParser.TermContext)
            else:
                return self.getTypedRuleContext(PrivugASGMTParser.TermContext,i)


        def getRuleIndex(self):
            return PrivugASGMTParser.RULE_add_term
    ...
    def add_term(self):
        ...
        localctx = PrivugASGMTParser.Add_termContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if la_ == 1:
                ...
                self.term()
                self.state = 33
                self.match(PrivugASGMTParser.T__2)
    ...
    class TermContext(ParserRuleContext):
        ...
        def NUM(self):
            return self.getToken(PrivugASGMTParser.NUM, 0)
        ...
        def sub(self):
            return self.getTypedRuleContext(PrivugASGMTParser.SubContext,0)


        def gm(self):
            return self.getTypedRuleContext(PrivugASGMTParser.GmContext,0)


        def getRuleIndex(self):
            return PrivugASGMTParser.RULE_term
    ...
    def term(self):
        ...
        localctx = PrivugASGMTParser.TermContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if la_ == 1:
                self.enterOuterAlt(localctx, 1)
                self.state = 39
                self.match(PrivugASGMTParser.NUM)
                pass
    ...
    class SymvarsContext(ParserRuleContext):
        ...
        def IDV(self):
            return self.getToken(PrivugASGMTParser.IDV, 0)

        def idd(self):
            return self.getTypedRuleContext(PrivugASGMTParser.IddContext,0)


        def getRuleIndex(self):
            return PrivugASGMTParser.RULE_symvars
    ...
    def symvars(self):
        ...
        localctx = PrivugASGMTParser.SymvarsContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if la_ == 1:
                self.enterOuterAlt(localctx, 1)
                self.state = 50
                self.match(PrivugASGMTParser.IDV)
                pass
    ...
    class IddContext(ParserRuleContext):
        ...
        def IDV(self, i:int=None):
            if i is None:
                return self.getTokens(PrivugASGMTParser.IDV)
            else:
                return self.getToken(PrivugASGMTParser.IDV, i)

        def NUM(self):
            return self.getToken(PrivugASGMTParser.NUM, 0)

        def getRuleIndex(self):
            return PrivugASGMTParser.RULE_idd
    ...
    def idd(self):
        ...
        localctx = PrivugASGMTParser.IddContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self.match(PrivugASGMTParser.IDV)
            self.state = 55
            self.match(PrivugASGMTParser.T__3)
            self.state = 56
            _la = self._input.LA(1)
            if not(_la==PrivugASGMTParser.IDV or _la==PrivugASGMTParser.NUM):
                self._errHandler.recoverInline(self)
            else:
                self._errHandler.reportMatch(self)
                self.consume()
            self.state = 57
            self.match(PrivugASGMTParser.T__4)
        except RecognitionException as re:
            localctx.exception = re
            self._errHandler.reportError(self, re)
            self._errHandler.recover(self, re)
    ...
    class GmContext(ParserRuleContext):
        ...
        def list_(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(PrivugASGMTParser.ListContext)
            else:
                return self.getTypedRuleContext(PrivugASGMTParser.ListContext,i)


        def getRuleIndex(self):
            return PrivugASGMTParser.RULE_gm
    ...
    def gm(self):
        ...
        localctx = PrivugASGMTParser.GmContext(self, self._ctx, self.state)
        self.enterRule(localctx, 12, self.RULE_gm)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 59
            self.match(PrivugASGMTParser.T__5)
            self.state = 60
            self.list_()
            self.state = 61
            self.match(PrivugASGMTParser.T__6)
            self.state = 62
            self.list_()
            self.state = 63
            self.match(PrivugASGMTParser.T__6)
            ...
            self.list_()
            self.state = 65
            self.match(PrivugASGMTParser.T__7)
        except RecognitionException as re:
            localctx.exception = re
            self._errHandler.reportError(self, re)
            self._errHandler.recover(self, re)
    ...
    class ListContext(ParserRuleContext):
        ...
        def NUM(self, i:int=None):
            if i is None:
                return self.getTokens(PrivugASGMTParser.NUM)
            else:
                return self.getToken(PrivugASGMTParser.NUM, i)

        def getRuleIndex(self):
            return PrivugASGMTParser.RULE_list
    ...
    def list_(self):
        ...
        localctx = PrivugASGMTParser.ListContext(self, self._ctx, self.state)
    ...
    class SubContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return PrivugASGMTParser.RULE_sub
    ...
    def sub(self):
        ...
        localctx = PrivugASGMTParser.SubContext(self, self._ctx, self.state)
        self.enterRule(localctx, 16, self.RULE_sub)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 78
            self.match(PrivugASGMTParser.T__8)
        except RecognitionException as re:
            localctx.exception = re
            self._errHandler.reportError(self, re)
            self._errHandler.recover(self, re)
