# Generated from PrivugTRUNC.g4 by ANTLR 4.10.1
# encoding: utf-8
from antlr4 import *
...
class PrivugTRUNCParser ( Parser ):

    grammarFileName = "PrivugTRUNC.g4"
    ...
    class TruncContext(ParserRuleContext):
        ...
        def ineq(self):
            return self.getTypedRuleContext(PrivugTRUNCParser.IneqContext,0)


        def eq(self):
            return self.getTypedRuleContext(PrivugTRUNCParser.EqContext,0)


        def getRuleIndex(self):
            return PrivugTRUNCParser.RULE_trunc
    ...
    def trunc(self):
        ...
        localctx = PrivugTRUNCParser.TruncContext(self, self._ctx, self.state)
    ...
    class IneqContext(ParserRuleContext):
        ...
        def lexpr(self):
            return self.getTypedRuleContext(PrivugTRUNCParser.LexprContext,0)


        def inop(self):
            return self.getTypedRuleContext(PrivugTRUNCParser.InopContext,0)


        def const(self):
            return self.getTypedRuleContext(PrivugTRUNCParser.ConstContext,0)


        def getRuleIndex(self):
            return PrivugTRUNCParser.RULE_ineq
    ...
    def ineq(self):
        ...
        localctx = PrivugTRUNCParser.IneqContext(self, self._ctx, self.state)
    ...
    class InopContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return PrivugTRUNCParser.RULE_inop
    ...
    def inop(self):
        ...
        localctx = PrivugTRUNCParser.InopContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if not((((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << PrivugTRUNCParser.T__0) | (1 << PrivugTRUNCParser.T__1) | (1 << PrivugTRUNCParser.T__2) | (1 << PrivugTRUNCParser.T__3))) != 0)):
    ...
    class EqContext(ParserRuleContext):
        ...
        def var(self):
            return self.getTypedRuleContext(PrivugTRUNCParser.VarContext,0)


        def eqop(self):
            return self.getTypedRuleContext(PrivugTRUNCParser.EqopContext,0)
        ...
        def getRuleIndex(self):
            return PrivugTRUNCParser.RULE_eq
    ...
    def eq(self):
        ...
        localctx = PrivugTRUNCParser.EqContext(self, self._ctx, self.state)
    ...
    class EqopContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return PrivugTRUNCParser.RULE_eqop
    ...
    def eqop(self):
        ...
        localctx = PrivugTRUNCParser.EqopContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self.state = 42
            _la = self._input.LA(1)
            if not(_la==PrivugTRUNCParser.T__4 or _la==PrivugTRUNCParser.T__5):
                self._errHandler.recoverInline(self)
            else:
                self._errHandler.reportMatch(self)
                self.consume()
    ...
    class LexprContext(ParserRuleContext):
        ...
        def monom(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(PrivugTRUNCParser.MonomContext)
            else:
                return self.getTypedRuleContext(PrivugTRUNCParser.MonomContext,i)


        def sum_(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(PrivugTRUNCParser.SumContext)
            else:
                return self.getTypedRuleContext(PrivugTRUNCParser.SumContext,i)


        def sub(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(PrivugTRUNCParser.SubContext)
            else:
                return self.getTypedRuleContext(PrivugTRUNCParser.SubContext,i)


        def getRuleIndex(self):
            return PrivugTRUNCParser.RULE_lexpr
    ...
    def lexpr(self):
        ...
        localctx = PrivugTRUNCParser.LexprContext(self, self._ctx, self.state)
        ...
        try:
            ...
            while _alt!=1 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1+1:
                    ...
                    if token in [PrivugTRUNCParser.T__12]:
                        self.state = 45
                        self.sum_()
                        pass
                    elif token in [PrivugTRUNCParser.T__13]:
                        self.state = 46
                        self.sub()
                        pass
                    else:
    ...
    class MonomContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return PrivugTRUNCParser.RULE_monom
    ...
    def monom(self):
        ...
        localctx = PrivugTRUNCParser.MonomContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if la_ == 1:
                ...
                self.const()
                self.state = 57
                self.match(PrivugTRUNCParser.T__6)
    ...
    class ConstContext(ParserRuleContext):
        ...
        def NUM(self):
            return self.getToken(PrivugTRUNCParser.NUM, 0)

        def idd(self):
            return self.getTypedRuleContext(PrivugTRUNCParser.IddContext,0)


        def getRuleIndex(self):
            return PrivugTRUNCParser.RULE_const
    ...
    def const(self):
        ...
        localctx = PrivugTRUNCParser.ConstContext(self, self._ctx, self.state)
        self.enterRule(localctx, 14, self.RULE_const)
        try:
            self.state = 65
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [PrivugTRUNCParser.NUM]:
                self.enterOuterAlt(localctx, 1)
                self.state = 63
                self.match(PrivugTRUNCParser.NUM)
                pass
            elif token in [PrivugTRUNCParser.IDV]:
                self.enterOuterAlt(localctx, 2)
                self.state = 64
                self.idd()
                pass
    ...
    class VarContext(ParserRuleContext):
        ...
        def IDV(self):
            return self.getToken(PrivugTRUNCParser.IDV, 0)
        ...
        def gm(self):
            return self.getTypedRuleContext(PrivugTRUNCParser.GmContext,0)


        def getRuleIndex(self):
            return PrivugTRUNCParser.RULE_var
    ...
    def var(self):
        ...
        localctx = PrivugTRUNCParser.VarContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if la_ == 1:
                self.enterOuterAlt(localctx, 1)
                self.state = 67
                self.match(PrivugTRUNCParser.IDV)
                pass
    ...
    class IddContext(ParserRuleContext):
        ...
        def IDV(self, i:int=None):
            if i is None:
                return self.getTokens(PrivugTRUNCParser.IDV)
            else:
                return self.getToken(PrivugTRUNCParser.IDV, i)

        def NUM(self):
            return self.getToken(PrivugTRUNCParser.NUM, 0)

        def getRuleIndex(self):
            return PrivugTRUNCParser.RULE_idd
    ...
    def idd(self):
        ...
        localctx = PrivugTRUNCParser.IddContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self.match(PrivugTRUNCParser.IDV)
            self.state = 73
            self.match(PrivugTRUNCParser.T__7)
            self.state = 74
            _la = self._input.LA(1)
            if not(_la==PrivugTRUNCParser.IDV or _la==PrivugTRUNCParser.NUM):
                self._errHandler.recoverInline(self)
            else:
                self._errHandler.reportMatch(self)
                self.consume()
            self.state = 75
            self.match(PrivugTRUNCParser.T__8)
        except RecognitionException as re:
            localctx.exception = re
            self._errHandler.reportError(self, re)
            self._errHandler.recover(self, re)
    ...
    class GmContext(ParserRuleContext):
        ...
        def list_(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(PrivugTRUNCParser.ListContext)
            else:
                return self.getTypedRuleContext(PrivugTRUNCParser.ListContext,i)


        def getRuleIndex(self):
            return PrivugTRUNCParser.RULE_gm
    ...
    def gm(self):
        ...
        localctx = PrivugTRUNCParser.GmContext(self, self._ctx, self.state)
        self.enterRule(localctx, 20, self.RULE_gm)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 77
            self.match(PrivugTRUNCParser.T__9)
            self.state = 78
            self.list_()
            self.state = 79
            self.match(PrivugTRUNCParser.T__10)
            self.state = 80
            self.list_()
            self.state = 81
            self.match(PrivugTRUNCParser.T__10)
            ...
            self.list_()
            self.state = 83
            self.match(PrivugTRUNCParser.T__11)
        except RecognitionException as re:
            localctx.exception = re
            self._errHandler.reportError(self, re)
            self._errHandler.recover(self, re)
    ...
    class ListContext(ParserRuleContext):
        ...
        def NUM(self, i:int=None):
            if i is None:
                return self.getTokens(PrivugTRUNCParser.NUM)
            else:
                return self.getToken(PrivugTRUNCParser.NUM, i)

        def getRuleIndex(self):
            return PrivugTRUNCParser.RULE_list
    ...
    def list_(self):
        ...
        localctx = PrivugTRUNCParser.ListContext(self, self._ctx, self.state)
    ...
    class SumContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return PrivugTRUNCParser.RULE_sum
    ...
    def sum_(self):
        ...
        localctx = PrivugTRUNCParser.SumContext(self, self._ctx, self.state)
        self.enterRule(localctx, 24, self.RULE_sum)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 96
            self.match(PrivugTRUNCParser.T__12)
        except RecognitionException as re:
            localctx.exception = re
            self._errHandler.reportError(self, re)
            self._errHandler.recover(self, re)
    ...
    class SubContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return PrivugTRUNCParser.RULE_sub
    ...
    def sub(self):
        ...
        localctx = PrivugTRUNCParser.SubContext(self, self._ctx, self.state)
        self.enterRule(localctx, 26, self.RULE_sub)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 98
            self.match(PrivugTRUNCParser.T__13)
        except RecognitionException as re:
            localctx.exception = re
            self._errHandler.reportError(self, re)
            self._errHandler.recover(self, re)
